...
const Testimonial = () => {
    return (
        <div>
            <section className="my-8 bg-[#B1BCBA] dark:text-gray-800 container mx-auto">
	<div className="container flex flex-col items-center p-4 mx-auto space-y-6 md:p-8">
		...
		<p className="px-6 py-2 text-2xl font-semibold text-center sm:font-bold sm:text-3xl md:text-2xl lg:max-w-2xl xl:max-w-4xl dark:text-gray-700">I recently revamped my living room with several wooden home decor pieces from [Store Name], and I couldn't be happier with the results! The natural, rustic charm of the wooden accents has completely transformed the space, making it feel warm and inviting.</p>
